    ...
    return (
        <div className="bg-black rounded-t-[45px] relative">
            ...
            <div className="flex flex-col pt-24 px-28 pb-24">
                <div className="opacity-[0.7] text-white font-medium leading-[normal]">[OUR CASE STUDIES]</div>
                <div className="relative flex flex-row mt-20 mb-8">
                ...
                <div className="cursor-pointer relative bg-[#DACDFF]/[.03] w-max ml-24 py-4 pl-16 pr-[88px] rounded-full linerBorderGradient">
                    See more projects
                ...
                <div className='grid grid-cols-5 gap-8 w-full px-56 pt-16'>
                    <div className='col-span-2 flex flex-col items-start gap-12'>
                        <div className='flex flex-col gap-3 w-full'>
                            <div className="text-white text-sm leading-[140%]">Your name*</div>
            ...
            <div className='px-36 py-32 flex flex-col w-full gap-14'>
                <nav className='flex flex-row items-center justify-between pt-[51px] z-10'>
