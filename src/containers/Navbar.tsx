...
const Navbar = () => {
    ...
    return (
        <div>
            <nav className='hidden md:flex absolute w-screen flex-row items-center justify-center pt-[51px] px-4 md:px-12 xl:px-20 z-50' style={{ background: "linear-gradient(180deg, rgba(0, 0, 0, 0.87), rgba(0, 0, 0, 0))" }}>
